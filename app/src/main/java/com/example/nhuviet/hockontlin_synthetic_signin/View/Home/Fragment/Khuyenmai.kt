...
import com.example.nhuviet.hockontlin_synthetic_signin.View.Home.View_RX2androidNetWorking.RX2_PotTable
import kotlinx.android.synthetic.main.layout_fragment_home.view.*

/**
 * Created by nhuvi on 11/08/2017.
 */
class Khuyenmai : Fragment() {

    @Nullable
    override fun onCreateView(inflater: LayoutInflater?, @Nullable container: ViewGroup?,
                              @Nullable savedInstanceState: Bundle?): View? {
        val view = inflater!!.inflate(R.layout.layout_khuyenmai, container, false)

        view.bt_Rx2.setOnClickListener{

            val intent = Intent(context, RX2_PotTable::class.java)
